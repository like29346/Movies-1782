...
#...
try:
    # Pyrogram शुरू होने से पहले print स्टेटमेंट
    print("🚀 Starting the Pyrogram Bot...")
    
    # बोट को चलाएँ और तब तक चालू रखें जब तक प्रोग्राम बंद न हो जाए
    app.run()
    
# 'except' और उसके अंदर की 'print' लाइन एक ही लेवल पर नहीं होनी चाहिए।
# 'except' को 'try' के लेवल पर, और उसके अंदर के कोड को इंडेंटेड होना चाहिए।

except Exception as e:
    # 'except' के अंदर की लाइन 4 स्पेस से इंडेंटेड होनी चाहिए
